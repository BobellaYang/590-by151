...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  4 19:15:21 2021
...
#ANN PARAM
layers        =    [-1,4,1] #FIRST NUMBER OVERWRITTEN LATER BY INPUT SHAPE
    ...
    if(model_type=="ANN"):
        ...
        def NN_eval(x, submatrices):
            ...
            for i in range(len(layers) - 1):
                #even indices of submatrices
                matmulsum = np.matmul(submatrices[2*i], out)
                out = matmulsum + submatrices[2*i+1]
                if activation == "TANH":
                    ...
                    print("Please use only TANH or SIGMOID as activation function!")
                    sys.exit()
